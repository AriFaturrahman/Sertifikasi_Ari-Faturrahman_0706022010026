...
class peminjam_bukuModel extends Model
{
    ...
    function post_insert($tboxinsertpeminjam)
    {
        ...
        $queryinsert = "INSERT INTO peminjaman( `kode_peminjaman`, `kode_koleksi`, `kode_anggota`, `tanggal_pinjam`, `tanggal_harus_kembali`, `status_peminjaman`) VALUES (:insertkode_peminjam, :insertkode_koleksi, :insertkode_anggota, :inserttanggal_pinjam, :inserttanggal_kembali, '0')";
    ...
    function get_semuaPeminjam()
    {
        ...
        INNER JOIN koleksi ON peminjaman.kode_koleksi = koleksi.kode_koleksi where status_peminjaman = '0';";
    ...
    // buat Query Update di page update anggota
    function post_pengembalianbuku($tboxpengembalianbuku)
    {
        $cmd = "UPDATE peminjaman SET status_peminjaman = '1' WHERE kode_peminjaman = :insertkode_peminjam";
        $result = DB::update($cmd, $tboxpengembalianbuku);
        // dd($result);
        return $result;
    }
}
